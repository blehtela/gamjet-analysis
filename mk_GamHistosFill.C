...
void mk_GamHistosFill(string dataset = "X", string puera = "", string version = "w60") { //using w-version names for my code (Bettina), w60 (25F), w59 (25D), moved to w58 (includes 25D start), w57 was WITHOUT L2L3Res 2025C for dpnote
...
*/
  ...
  bool addData = (dataset=="2016B"  || dataset=="2016C" || dataset=="2016D" || 
      ...
      dataset=="2025B" || dataset=="2025C" || dataset=="2025Cv2" || dataset=="2025D" || dataset=="2025E" || dataset=="2025F"); //added 2025 data on 20.05.2025, w50; added 25Cv2 and 25D on 06.08.2025, w58. 25E on 15sep2025, still w59. 25F on 15sep2025, w60.
