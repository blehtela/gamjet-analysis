...
void mk_GamHistosFill(string dataset = "X", string puera = "", string version = "w82") { //using w-version names for my code (Bettina), w60 (25F), w59 (25D), moved to w58 (includes 25D start), w57 was WITHOUT L2L3Res 2025C for dpnote
...
*/
  ...
  bool addData = (dataset=="2016B"  || dataset=="2016C" || dataset=="2016D" || 
    ...
    //like for 2025 DATA:
		...
		TString(dataset.c_str()).Contains("2025Fv1") || TString(dataset.c_str()).Contains("2025Fv2") || TString(dataset.c_str()).Contains("2025G") || 
