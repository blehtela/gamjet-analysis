...
*/
  ...
  bool addData = (dataset=="2016B"  || dataset=="2016C" || dataset=="2016D" || 
      ...
      dataset=="2024B" || dataset=="2024C" || dataset=="2024D" || dataset=="2024Ev1" || dataset=="2024Ev2" || 
			...
			dataset=="2024H" || dataset=="2024Ha" || dataset=="2024Hb" || dataset=="2024Hc" || dataset=="2024Hd" || dataset=="2024He" || dataset=="2024Htest" ||
			dataset=="2024I" || dataset=="2024Ia" || dataset=="2024Ib" || dataset=="2024Ic" || dataset=="2024Id" || dataset=="2024Ie" || dataset=="2024Itest" ||
