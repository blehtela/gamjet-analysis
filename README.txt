...
w25: Added hgam50t to control-directory (tight 50GeV photon trigger); updated daily JSON (26.5.); updated lumi-files accordingly; still using same jetveto and same JEC as previous versions.
