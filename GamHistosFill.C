 ...
 */
  ...
  if (ds=="2024Ev1" || ds=="2024Ev2"){ //separated 24E corrections starting from V4M jecs
	...
	if (ds=="2024G" || ds=="2024Gtest" || ds=="2024Ga" || ds=="2024Gb" || ds=="2024Gc" || ds=="2024Gd" || ds=="2024Ge" ||
		...
		ds=="2024I" || ds=="2024Iskim" || ds=="2024Itest" || ds=="2024Ia" || ds=="2024Ib" || ds=="2024Ic" || ds=="2024Id" || ds=="2024Ie") { //for 2024 re-reco data, but also for 2024F and onwards (fixed in w33)
  ...
  if (ds=="2024Fa" || ds=="2024Fb" || ds=="2024Fc" || ds=="2024Fd" || ds=="2024Ga" || ds=="2024Gb" || ds=="2024Gc" || ds=="2024Gd" || ds=="2024Ge" ||
	ds=="2024Hskim" || ds=="2024Ha" || ds=="2024Hb" || ds=="2024Hc" || ds=="2024Hd" || ds=="2024Iskim" || ds=="2024Ia" || ds=="2024Ib" || ds=="2024Ic" || ds=="2024Id" || ds=="2024Ie") sera = "2024";
...
//for now also use jetvetomap 2023D for the new 2024B prompt reco data:
  if (TString(ds.c_str()).Contains("2024")) {
    ...
    if (TString(ds.c_str()).Contains("2024F") || //should include Fa, Fb, Fc, Fd
        ...
        TString(ds.c_str()).Contains("2024I") || //should include Ia, Ib, Ic, Id, Iskim
        TString(ds.c_str()).Contains("winter2024P8") || //also for MC now 2024.
