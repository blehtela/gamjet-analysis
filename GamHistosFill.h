...
//include some new stuff for JER smearing (added 25.04.2026)
  ...
  : fChain(0), isMC(itype), dataset(datasetname), puera(pueraname), jersfver(jersfvername), version(versionname)
{
  ...
  is24 = (ds=="2024B-PromptReco-v1" || ds=="2024B" || ds=="2024C" || ds=="2024D" || ds=="2024Ev1" || ds=="2024Ev2" || 
		...
		ds=="2024P8" || ds=="2024QCD" || ds=="summer2024P8" || ds=="summer2024QCD" || ds=="summer2024P8-test" || ds=="summer2024P8-tiny-test" || //added tiny-test (w80, 26.04.2026)
...
void GamHistosFill::Init(TTree *tree)
{
  ...
  //if(is25 || is26){
   ...
   if (is24 || is25 || is26) fChain->SetBranchAddress("Jet_hfEmEF", Jet_hfEmEF, &b_Jet_hfEmEF);   //new in 2024
   if (is24 || is25 || is26) fChain->SetBranchAddress("Jet_hfHEF", Jet_hfHEF, &b_Jet_hfHEF);      //new in 2024
   ...
   } // is17 || is18 || is22 || is23 || is24 || is25 || is26
   if (is17 && !isMC) {
