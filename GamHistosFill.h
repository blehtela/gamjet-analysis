...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //Bool_t          HLT_Photon55EB_TightID_TightIso; //commented out since w44
  ...
  : fChain(0), isMC(itype), dataset(datasetname), puera(pueraname), version(versionname)
{
  ...
  is23 = (ds=="2023B" || ds=="2023Cv123" || ds=="2023Cv4" || ds=="2023D" ||
	  ds=="2023Bnib1" || ds=="2023Cv123nib1" || ds=="2023Cv4nib1" || ds=="2023Cv4nib2" || ds=="2023Dnib1" || //nibs and fibs
  ...
  is24 = (ds=="2024B-PromptReco-v1" || ds=="2024B" || ds=="2024C" || ds=="2024D" || ds=="2024Ev1" || ds=="2024Ev2" || 
					ds=="2024F" || ds=="2024Fa" || ds=="2024Fb" || ds=="2024Fc" || ds=="2024Fd" || ds=="2024F-ECALCC-HCALDI-skim" || ds=="2024F-ECALCC-HCALDI-2ndrereco" ||
...
//should do this with "Contains()" fct... more compact
  ...
  is25 = (ds=="2025B" || ds=="2025C" ||  ds=="2025Cv2" || ds=="2025D" || ds=="2025E" ||  ds=="2025F" ||//added first on 20.05.2025 (w50), added 25Cv2 and 25D on 06.08.2025 (w58), added 25E on 15.09.2025 (still w59), added 25F on 15.09.2025 (move to w60)
          ds=="winter2025P8" ||
...
void GamHistosFill::Init(TTree *tree)
{
   ...
   if (!(is22 || is23 || is24 || is25)) fChain->SetBranchAddress("Jet_btagDeepB", Jet_btagDeepB, &b_Jet_btagDeepB);
   if (!(is22 || is23 || is24 || is25)) fChain->SetBranchAddress("Jet_btagDeepC", Jet_btagDeepC, &b_Jet_btagDeepC);
  ...
  if(is25){ //need these branches to replace jetID
   ...
   if (is24 || is25) fChain->SetBranchAddress("Jet_hfEmEF", Jet_hfEmEF, &b_Jet_hfEmEF);   //new in 2024
   if (is24 || is25) fChain->SetBranchAddress("Jet_hfHEF", Jet_hfHEF, &b_Jet_hfHEF);      //new in 2024

   fChain->SetBranchAddress("Jet_phi", Jet_phi, &b_Jet_phi);
   fChain->SetBranchAddress("Jet_pt", Jet_pt, &b_Jet_pt);
   //fChain->SetBranchAddress("Jet_puIdDisc", Jet_puIdDisc, &b_Jet_puIdDisc);
   if (!(is22 || is23 || is24 || is25)) fChain->SetBranchAddress("Jet_qgl", Jet_qgl, &b_Jet_qgl);
   fChain->SetBranchAddress("Jet_rawFactor", Jet_rawFactor, &b_Jet_rawFactor);
   if(!is25) fChain->SetBranchAddress("Jet_jetId", Jet_jetId, &b_Jet_jetId); //only if not nanoAOD v15 (starting 2025)
   ...
   if (!(is22 || is23 || is24 || is25)) fChain->SetBranchAddress("Photon_mass", Photon_mass, &b_Photon_mass);
